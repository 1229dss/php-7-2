...
<section>
  <div class="entry_field">
    <form method="post" action="experience_register" name="input_form" id="input_form">
      @csrf
      <input type="hidden" name="user_id" value={{$id}}>
        ...
        <div class="placeholder_wrapper">
          <p>
            <textarea id='skill' type="text" name="skill">@if(session('skill')){{session('skill')}}@endif</textarea>
          </p>
        ...
        <div class="placeholder_wrapper">
          <p>
            <textarea id='licence' type="text" name="licence">@if(session('licence')){{session('licence')}}@endif</textarea>
          </p>
        ...
        <p>
          <textarea id='summary' type="text" name="summary" placeholder="300字程度(250～350字)">@if(session('summary')){{session('summary')}}@endif</textarea>
        </p>
        <h3>
        ...
        <div class="btn_area">
          ...
          <input class="btn experience_register" type="submit" value="登録">
